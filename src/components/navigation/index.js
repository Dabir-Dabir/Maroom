    ...
    return (
        <nav className="navigation">
            <menu className="navigation__menu">
                <li className="navigation__list d-md-none"><a href="#" className="navigation__link">Главная</a></li>
                <li className="navigation__list"><a href="#" className="navigation__link">Сдать</a></li>
                <li className="navigation__list"><a href="#" className="navigation__link">Снять</a></li>
                <li className="navigation__list"><a href="#" className="navigation__link">О сервисе</a></li>
                <li className="navigation__list"><a href="#" className="navigation__link">Блог</a></li>
            </menu>
            <a href="#" className="navigation__login-button btn btn--type_primary btn--size_m btn--display_left-icon">
