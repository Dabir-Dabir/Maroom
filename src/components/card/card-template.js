...
const CardTemplate = ({data, onTapPrev, onTapNext}) => {
        ...
        <Fragment>
            <header className="card__header">
                ...
                <div className="card__controllers">
                    <button onClick={ () => {onTapPrev(goLeft)} } className={leftControllerClass}>
                        <img src={leftImage} alt="" className="card__icon card__left-icon"/>
                    </button>
                    <button onClick={ () => {onTapNext(goRight)} } className={rightControllerClass}>
